...
public class ImageChunker implements BlockChunker<ImageBlock> {
    ...
    public List<VectorChunk> chunk(ImageBlock block, ChunkContext ctx) {
        ...
        String displayUrl = StringUtils.hasText(asset.publicUrl()) ? asset.publicUrl() : asset.originalUrl();
        String markdown = "![" + visible + "](" + displayUrl + ")";
        ...
        VectorChunk chunk = VectorChunk.builder()
                ...
                .content(content)
                .embeddingText(hasDescription ? embeddingText : visible)
    ...
    private String resolveImageUrl(AssetRef asset) {
